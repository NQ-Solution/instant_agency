...
const pages = [
  { id: 'home', name: 'Home', description: 'Main landing page with hero, divisions, and featured content' },
  { id: 'about', name: 'About', description: 'Company story, values, and team information' },
  { id: 'models', name: 'Models', description: 'Model listing and filtering options' },
  { id: 'studio', name: 'Studio', description: 'Studio services, spaces, and pricing' },
  { id: 'live', name: 'Live Commerce', description: 'Live commerce services and creator showcase' },
  { id: 'contact', name: 'Contact', description: 'Contact form and office information' },
];
    ...
    <div className="space-y-6">
      ...
      <div className="mt-8 p-6 bg-[var(--text)]/5 rounded-lg">
        ...
        <p className="text-sm text-[var(--text-muted)]">
          ...
          현재 샘플 데이터 모드에서는 변경사항이 세션 동안만 유지됩니다.
        </p>
      </div>
    </div>
  );
